...
- Analytics normalize `MONTHLY` base salary to an annual amount by multiplying by 12; `ANNUAL` records are used as-is. Bonuses and allowances are not included in salary-band analytics.
